...
| bg0 | 235 | `#262626` | Main background |
| bg1 | 237 | `#3a3a3a` | Bar backgrounds, separators |
| bg2 | 239 | `#4e4e4e` | Marked lines, highlight bg |
...
|------|----------|-----|-------------|-------|
| Sakura Pink | 175 | `#d787af` | Cherry blossom (桜) | Network, prefixes, highlights |
| Rose | 168 | `#d75f87` | Deep petals | Errors, quits, kicks |
| Pale Pink | 217 | `#ffafaf` | Fallen petals | Nick variety |
...
| Moonlight | 110 | `#87afd7` | Moon through branches | Channels, buffers, paths |
...
|------|----------|-----|-------|
| Deep Rose | 53 | `#5f005f` | Search/emphasis bg |
| Dusk | 60 | `#5f5f87` | Twilight accents |
...
Bar background (bg1)               Dark grove       237
...
Blue (→ Moonlight)                 Moon glow        110
Purple (→ Sakura)                  Cherry blossom   175
Aqua (→ Sage)                      Garden moss      108
